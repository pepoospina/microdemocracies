...
export enum I18Keys {
  ...
  approveNew=
  askSupport=
  applicationAcceptedAs=
  important=
  atLeastNMembers=   
  canBackN=
  aStatementNeeds=
  maxStatementsPerPeriod=
  ownedBy=
  send=
  likesNeeded=
  likesNeededDetailed=
  ...
  projectAddress=
  leave=
  accountValidatedNotChallenged=
  challenge=
  cantChallenge=
  pendingApplicationBy=
  votedNofMEligible=
  preparingData=
  approvingNewMember=
  finish=
  ...
  exit=
  alreadyBacked=
  cannotPublishStatement=
  cannotPublishStatementPeriod=
}
  ...
  resources: {
    ENG: {
      translation: {
        ...
        preparingIdentity: 'Preparing your anonymous identity...',
    ...
    SPA: {
      translation: {
        ...
        waitingSignature: 'Creando Identificación Pública - Esperando Firmas',
        ...
        connectingUser: 'Connecting user',
        pleaseSignIn: 'Por favor inicia sesión para ver tus microdemocracias',
        justAMoment: 'Un momento por favor...',
        waitingTransaction: 'Enviando transacción a la red...',
        registeringProject: 'Registrando tu microdemocracia...',
      },
    },
    CAT: {
      translation: {
        ...
        waitingSignature: 'Creant Identificació Pública - Esperant Firmes',
