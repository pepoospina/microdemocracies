  ...
  resources: {
    ENG: {
      translation: {
        ...
        atLeastNMembers: 'Debe haber al menos 3 miembros para proponer una declaración',
        canBackN: 'Only the existing {{nMembers}} members will be able to back this statement',
        ownedBy: 'Owned by',
        send: 'Send',
        likesNeeded: '{{nLikes}} more likes needed!',
      },
    },
    SPA: {
      translation: {
        ...
        atLeastNMembers: 'There must be at least 3 members to propose a statement',
        canBackN: 'Únicamente los {{nMembers}} miembros actuales podrán apoyar esta declaración',
        ownedBy: 'Controlada por',
        send: 'Enviar',
        likesNeeded: 'Hacen falta {{nLikes}} apoyos más para ser publicado!',
      },
    },
    CAT: {
      translation: {
        ...
        ownedBy: 'Controlada per',
        send: 'Enviar',
        likesNeeded: 'Calen {{nLikes}} suports més per ser publicat!',
      },
    },
  },
