  ...
  return (
    <Box>
      <BoxCentered style={{ height: '30vh' }}>
        <Text style={{ fontSize: fontSizeLarge, lineHeight: '150%', fontWeight: '300' }}>{props.mainText}</Text>
      </BoxCentered>
      <Box style={{ marginTop: '24px' }}>
        <Text style={{ fontSize: fontSizeSmall, lineHeight: '150%', fontWeight: '300' }}>{props.secondaryText}</Text>
      </Box>
    </Box>
  );
};
